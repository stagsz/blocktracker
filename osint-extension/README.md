# OSINT 2.1 Chrome Extension

Professional OSINT Intelligence Prompt Generator - now as a browser extension with direct AI integration.
...
- ✅ 4-phase OSINT methodology prompt generation
- ✅ Copy to clipboard
...
3. Click **Reload** button on OSINT 2.1 extension
...
- Click **Service Worker** link under OSINT 2.1
...
- `osint_templates` - Your saved investigation templates
...
**Built with ❤️ for OSINT professionals**
